...
Using your computer keyboard (and the shortcuts you set up from the gSender Configuration Guide), navigate the tool to where you want the origin of your part to start. Remember: this is where the WORK ZERO coordinates system was placed in Step 3 of Part 1 (Southwest, highest Z).  
